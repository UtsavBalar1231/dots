---
title: Making your keyboard dance - kitty
url: https://sw.kovidgoyal.net/kitty/mapping/
---

---
meta-color-scheme: light dark
meta-description: kitty has extremely powerful facilities for mapping keyboard actions. Things like combining actions, multi-key mappings, modal mappings, mappings that send arbitrary text, and mappings dependent on...
meta-og-description: kitty has extremely powerful facilities for mapping keyboard actions. Things like combining actions, multi-key mappings, modal mappings, mappings that send arbitrary text, and mappings dependent on...
meta-og-image: "https://sw.kovidgoyal.net/kitty/_images/social_previews/summary_mapping_aea5afa6.png"
meta-og-image-alt: kitty has extremely powerful facilities for mapping keyboard actions. Things like combining actions, multi-key mappings, modal mappings, mappings that send a...
meta-og-image-height: 600
meta-og-image-width: 1146
meta-og-site_name: kitty
meta-og-title: Making your keyboard dance
meta-og-type: website
meta-og-url: "https://sw.kovidgoyal.net/kitty/mapping/"
meta-twitter:card: summary_large_image
meta-viewport: width=device-width, initial-scale=1
title: Making your keyboard dance - kitty
---

![SVG Image](data:image/svg+xml;base64,)[Skip to content](#furo-main-content)
...
# Making your keyboard dance[¶](#making-your-keyboard-dance "Link to this heading")
...
This will map the key press `Ctrl`+`a` to open a new [window](../glossary/#term-window) with the working directory set to the working directory of the current window.
This is the basic operation of the map directive, the tip of the iceberg, for
more read the sections below.

## Combining multiple actions on a single keypress[¶](#combining-multiple-actions-on-a-single-keypress "Link to this heading")

Multiple actions can be combined on a single keypress, like a macro. To do this
map the key press to the [`combine`](../actions/#action-combine) action:
...
### Remote control scripts[¶](#remote-control-scripts "Link to this heading")

These can be written in any language and use the “kitten” binary to control
kitty via its extensive [Remote control](../remote-control/) API. First,
...
### Kittens[¶](#kittens "Link to this heading")
...
Many of kitty’s features are themselves implemented as kittens, for example,[Unicode input](../kittens/unicode_input/), [Hints](../kittens/hints/) and [Changing kitty colors](../kittens/themes/). To learn about writing your own kittens, see [Custom kittens](../kittens/custom/).

## Syntax for specifying keys[¶](#syntax-for-specifying-keys "Link to this heading")

A mapping maps a key press to some action. In their most basic form, keypresses
are `modifier+key`. Keys are identified simply by their lowercase Unicode
characters. For example: `a` for the `A` key, `[` for the left
square bracket key, etc. For functional keys, such as `Enter` or `Escape`, the names are present at [Functional key definitions](../keyboard-protocol/#functional). For modifier keys, the names are `ctrl` (`control`, `⌃`), `shift` (`⇧`), `alt` (`opt`, `option`, `⌥`), `super` (`cmd`, `command`, `⌘`).

Additionally, you can use the name [`kitty_mod`](../conf/#opt-kitty.kitty_mod) as a modifier, the default
value of which is `ctrl`+`shift`. The default kitty shortcuts are defined
using this value, so by changing it in `kitty.conf` you can change
...
names. See [XKB keys](https://github.com/xkbcommon/libxkbcommon/blob/master/include/xkbcommon/xkbcommon-keysyms.h) for a list of key names. The name to use is the part after the `XKB_KEY_` prefix. Note that you can only use an XKB key name for keys that are not known
as kitty keys.
...
with the [`kitty --debug-input`](../invocation/#cmdoption-kitty-debug-input) option, kitty will output some debug text
for every key event. In that text look for `native_code`, the value
...
## Multi-key mappings[¶](#multi-key-mappings "Link to this heading")
...
The default mappings to run the [hints kitten](../kittens/hints/) to select text on the screen are
examples of multi-key mappings.

## Unmapping default shortcuts[¶](#unmapping-default-shortcuts "Link to this heading")

kitty comes with dozens of default keyboard mappings for common operations. See[Mappable actions](../actions/) for the full list of actions and the default shortcuts that map
...
This unmaps the default shortcut [`ctrl+shift+enter`](../conf/#shortcut-kitty.New-window) to open a new window. Almost
all default shortcuts are of the form `modifier + key` where the
modifier defaults to `Ctrl`+`Shift` and can be changed using the [`kitty_mod`](../conf/#opt-kitty.kitty_mod) setting
in `kitty.conf`.

If you want to clear all default shortcuts, you can use[`clear_all_shortcuts`](../conf/#opt-kitty.clear_all_shortcuts) in `kitty.conf`.

If you would like kitty to completely ignore a key event, not even sending it to
the program running in the terminal, map it to [`discard_event`](../actions/#action-discard_event):

    map kitty_mod+f1 discard_event

## Conditional mappings depending on the state of the focused window[¶](#conditional-mappings-depending-on-the-state-of-the-focused-window "Link to this heading")
...
This will cause `kitty_mod`+`t` (the default shortcut for opening a new tab)
to be unmapped only when the focused window
has `keyboard protocol` in its title. Run the show-key kitten as:

    kitten show-key -m kitty

Press `ctrl`+`shift`+`t` and instead of a new tab opening, you will
see the key press being reported by the kitten. `--when-focus-on` can test
the focused window using very powerful criteria, see [Matching windows and tabs](../remote-control/#search-syntax) for
...
In `~/.vimrc` add:
:   let &t_ti = &t_ti . "\033]1337;SetUserVar=in_editor=MQo\007"let &t_te = &t_te . "\033]1337;SetUserVar=in_editor\007"

neovim

In `~/.config/nvim/init.lua` add:
> vim.api.nvim_create_autocmd({ "VimEnter", "VimResume", "UIEnter" }, {    group = vim.api.nvim_create_augroup("KittySetVarVimEnter", { clear = true }),    callback = function()        if vim.api.nvim_ui_send then            vim.api.nvim_ui_send("\x1b]1337;SetUserVar=in_editor=MQo\007")        else            io.stdout:write("\x1b]1337;SetUserVar=in_editor=MQo\007")        end    end,})
>
> vim.api.nvim_create_autocmd({ "VimLeave", "VimSuspend" }, {    group = vim.api.nvim_create_augroup("KittyUnsetVarVimLeave", { clear = true }),    callback = function()        if vim.api.nvim_ui_send then            vim.api.nvim_ui_send("\x1b]1337;SetUserVar=in_editor=MQo\007")        else            io.stdout:write("\x1b]1337;SetUserVar=in_editor\007")        end    end,})

These cause the editor to set the `in_editor` variable in kitty and unset it when exiting.
As a result, the `ctrl`+`shift`+`c` key will be passed to the editor instead of
...
When using multi-key mappings, of the form `k1>k2` or similar, the
...
## Sending arbitrary text or keys to the program running in kitty[¶](#sending-arbitrary-text-or-keys-to-the-program-running-in-kitty "Link to this heading")

This is accomplished by using `map` with [`send_text`](../conf/#shortcut-kitty.Send-arbitrary-text-on-key-presses) in `kitty.conf`.
For example:

    map f1 send_text normal,application Hello, world!

Now, pressing `f1` will cause `Hello, world!` to show up at your shell
...
To have one key press send another key press, use [`send_key`](../actions/#action-send_key):

    map alt+s send_key ctrl+s

This causes the program running in kitty to receive the `ctrl`+`s` key when
you press the `alt`+`s` key. To see this in action, run:

    kitten show-key -m kitty

Which will print out what key events it receives.

## Modal mappings[¶](#modal-mappings "Link to this heading")
...
example, lets create a mode to manage windows: switching focus, moving the window, etc.:
    ...
    # Create a new "manage windows" mode (mw)map --new-mode mw kitty_mod+f7

    # Switch focus to the neighboring window in the indicated direction using arrow keysmap --mode mw left neighboring_window leftmap --mode mw right neighboring_window rightmap --mode mw up neighboring_window upmap --mode mw down neighboring_window down

    # Move the active window in the indicated directionmap --mode mw shift+up move_window upmap --mode mw shift+left move_window leftmap --mode mw shift+right move_window rightmap --mode mw shift+down move_window down

    # Resize the active windowmap --mode mw n resize_window narrowermap --mode mw w resize_window widermap --mode mw t resize_window tallermap --mode mw s resize_window shorter

    # Exit the manage window modemap --mode mw esc pop_keyboard_mode

Now, if you run kitty as:

    kitty -o enabled_layouts=vertical --session <(echo "launch\nlaunch\nlaunch")

Press `Ctrl`+`Shift`+`F7` to enter the mode and then press the up and
down arrow keys to focus the next/previous window. Press `Shift`+`Up` or `Shift`+`Down` to move the active window up and down. Press `t` to make
the active window taller and `s` to make it shorter. To exit the mode
press `Esc`.
...
below:
    ...
    # Beep on unknown keysmap --new-mode XXX --on-unknown beep ...# Ignore unknown keys silentlymap --new-mode XXX --on-unknown ignore ...# Beep and exit the keyboard mode on unknown keymap --new-mode XXX --on-unknown end ...# Pass unknown keys to the program running in the active windowmap --new-mode XXX --on-unknown passthrough ...
...
below:
    ...
    # Have this keyboard mode automatically exit after performing any actionmap --new-mode XXX --on-action end ...

## All mappable actions[¶](#all-mappable-actions "Link to this heading")

There is a list of [all mappable actions](../actions/).

## Debugging mapping issues[¶](#debugging-mapping-issues "Link to this heading")
...
not support all keys and key events. To debug the [full kitty keyboard
...
- [Making your keyboard dance](#)
  - [Combining multiple actions on a single keypress](#combining-multiple-actions-on-a-single-keypress)
    - [Remote control scripts](#remote-control-scripts)
    - [Kittens](#kittens)
  - [Syntax for specifying keys](#syntax-for-specifying-keys)
  - [Multi-key mappings](#multi-key-mappings)
  - [Unmapping default shortcuts](#unmapping-default-shortcuts)
  - [Conditional mappings depending on the state of the focused window](#conditional-mappings-depending-on-the-state-of-the-focused-window)
  - [Sending arbitrary text or keys to the program running in kitty](#sending-arbitrary-text-or-keys-to-the-program-running-in-kitty)
  - [Modal mappings](#modal-mappings)
  - [All mappable actions](#all-mappable-actions)
  - [Debugging mapping issues](#debugging-mapping-issues)
