...
-- Kanged from: https://github.com/LazyVim/LazyVim/blob/v14.6.0/lua/lazyvim/util/root.lua
...
function M.info()
	...
	lines[#lines + 1] = "```"
	-- vim.notify(lines, { title = "Vim Roots" })
...
function M.setup()
	vim.api.nvim_create_user_command("Root", function()
		Util.root.info()
	end, { desc = "Vim roots for the current buffer" })
