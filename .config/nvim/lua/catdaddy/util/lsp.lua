---@class catdaddy.util.lsp
local M = {}
-- Kanged from: https://github.com/LazyVim/LazyVim/blob/v14.6.0/lua/lazyvim/util/lsp.lua
...
function M.get_raw_config(server)
	...
	ret = require("lspconfig.server_configurations." .. server)
	return ret
end
