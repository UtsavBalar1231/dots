vim.api.nvim_create_autocmd("User", {
	...
	callback = function(event)
		if event.data.actions.type == "move" then
			-- Notify LSP servers about file rename
			local old_name = vim.uri_to_fname(event.data.actions.src_url)
			local new_name = vim.uri_to_fname(event.data.actions.dest_url)
