...
keymap("n", "<Leader>fe", notify("workbench.actions.view.problems"), opts) -- language diagnostics
keymap("n", "gr", notify("editor.action.goToReferences"), opts)
keymap("n", "<Leader>ln", notify("editor.action.rename"), opts)
keymap("n", "<Leader>F", notify("editor.action.formatDocument"), opts)
keymap("n", "<Leader>qf", notify("editor.action.quickFix"), opts) -- language code actions
